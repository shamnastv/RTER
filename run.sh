...
python3 main.py --hidden_dim 300 --max_window_size 40 --epochs 50 --lr 5e-5 --dataset MELD --dropout .5 --num_layers 1
python3 main.py --hidden_dim 300 --max_window_size 40 --epochs 50 --lr 8e-5 --dataset MELD --dropout .5 --num_layers 1
