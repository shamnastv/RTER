...
python3 main.py --hidden_dim 300 --max_window_size 40 --epochs 50 --lr 2.5e-4 --dataset MELD --dropout .5 --num_layers 1
python3 main.py --hidden_dim 300 --max_window_size 40 --epochs 50 --lr 1e-4 --dataset MELD --dropout .5 --num_layers 1
